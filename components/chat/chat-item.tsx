...
import { formChatItem } from "@/db/form-schema";
...
export const ChatItem = ({
  ...
  const form = useForm<z.infer<typeof formChatItem>>({
    resolver: zodResolver(formChatItem),
    defaultValues: {
      content: content,
    },
  });
  ...
  const onSubmit = async (values: z.infer<typeof formChatItem>) => {
    try {
